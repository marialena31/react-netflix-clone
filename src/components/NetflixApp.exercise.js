    ...
    <div>
      ...
      <header className="banner">
        <div className="banner__contents">
          ...
          <div className="banner__buttons">
            ...
            <button className="banner__buttons banner__buttonInfo">Ajouter à ma liste</button>
          </div>
      ...
      <div className="row">
        ...
        <div className="row__posters">
          <img src="images/sample.jpg" alt="" className="row__poster row__posterLarge"/>
          <img src="images/sample1.jpg" alt="" className="row__poster row__posterLarge"/>
          <img src="images/sample.jpg" alt="" className="row__poster row__posterLarge"/>
          <img src="images/sample1.jpg" alt="" className="row__poster row__posterLarge"/>
        </div>
      </div>
